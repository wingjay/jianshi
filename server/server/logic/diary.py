...
def create_diary(user_id, title, content):
    ...
    return db_diary.create_diary(user_id, title, content)


def get_diary(user_id, diary_id):
    diary = db_diary.get_diary(diary_id)
...
def update_diary(user_id, diary_id, title, content):
    ...
    """
    db_diary.update_diary(user_id, diary_id, title, content)


def delete_diary(user_id, diary_id):
    db_diary.delete_diary(user_id, diary_id)