...
poems = [
    '草在结它的种子,风在摇它的叶子,-我们站着不说话,就十分美好-情人节快乐',
    '只要记住你的名字，-不管你在世界的哪个地方，-我一定会去见你。',
    '我希望有个如你一般的人-如山间清爽的风-情人节快乐',
    '我放下过天地-却从未放下过你-情人节快乐',
    '安得与君相决绝-免教生死作相似-给有情的你',
    '我行遍世间所有路,逆着时光行走-只为今生与你邂逅-情人节快乐',
    '第一最好不相见- -如此便可不相恋',
    '一世情缘一世恋-千年情愫叹难圆-给有情人',
    '纳木措湖等了我多少年- -我便等了你多少年',
]
