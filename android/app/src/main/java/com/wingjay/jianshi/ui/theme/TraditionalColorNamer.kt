 ...
 */
enum class TraditionalColorNamer constructor(val colorRes: Int, val colorName: String) {
  ...
  companion object {
    var allColorNamer: List<TraditionalColorNamer>

    init {
      val list = arrayOf(DEFAULT, ZHU_QING, CHI_JIN, QIAN_BAI, YING_BAI, SU, YUE_BAI, SHUI_HONG, CANG_HUANG, DING_XIANG_SE, AI_LV, YU_SE, HUANG_LU, JIANG_HUANG)
      allColorNamer = Arrays.asList(*list)
    }
  }
}
